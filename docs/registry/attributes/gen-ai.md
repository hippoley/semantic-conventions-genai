...
| <a id="gen-ai-tool-call-decision-outcome" href="#gen-ai-tool-call-decision-outcome">`gen_ai.tool.call.decision.outcome`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The explicit pre-execution decision for a proposed tool call. | `allow`; `deny`; `require_approval` |
