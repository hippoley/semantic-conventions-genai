...
- [Event: `gen_ai.tool.call.decision`](#event-gen_aitoolcalldecision)
...
## Event: `gen_ai.tool.call.decision`

<!-- weaver .registry.events[] | select(.name == "gen_ai.tool.call.decision") -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
The event name MUST be `gen_ai.tool.call.decision`.

Describes an explicit pre-execution decision for a proposed GenAI tool call.

This event SHOULD be recorded only when a framework, harness, application policy, or human approval flow makes an explicit decision before tool execution.
A denied tool call can produce this event without producing an `execute_tool` span. Instrumentations SHOULD use `gen_ai.tool.call.id` to correlate the decision with the proposed call when the identifier is available.
This event is not intended for generic hook lifecycle telemetry or post-execution tool outcomes.
...
| Key | Stability | [Requirement Level](https://opentelemetry.io/docs/specs/semconv/general/attribute-requirement-level/) | Value Type | Description | Example Values |
| --- | --- | --- | --- | --- | --- |
| [`gen_ai.tool.call.decision.outcome`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Required` | string | The explicit pre-execution decision for a proposed tool call. | `allow`; `deny`; `require_approval` |
...
| [`gen_ai.tool.name`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` If available. | string | Name of the tool utilized by the agent. | `Flights` |
